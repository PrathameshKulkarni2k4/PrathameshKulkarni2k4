...
- 🛠️ **Building:** [DigiPanchayat](https://github.com/PrathameshKulkarni2k4/AI-Powered-Rural-Governance-System) (AI Governance System via .NET 10 & Angular)
...
| **Frontend** | HTML5, CSS3, React.js, Angular, Tailwind CSS, Nextjs|
| **Backend** | .NET, Node.js, Express.js, supabase|
| **Databases** | MSSQL, MongoDB, MySQL, postgreSql |
| **Dev Tools** | Git, GitHub, Figma, Postman, Entity Framework |
